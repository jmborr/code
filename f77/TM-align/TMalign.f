...
ccc   
     ...
     $        'length of ''target.pdb'')'
         write(*,*)'  >TMalign -s structure.pdb -t target.pdb'
         write(*,*)
         write(*,*)'2. Run TM-align and output the superposition ',
     $        'to ''TM.sup'':'
         write(*,*)'   (To view the superimposed structures by ',
     $        'rasmol: >rasmol -script TM.sup)'
         write(*,*)'  >TMalign structure.pdb target.pdb -o TM.sup'
c         write(*,*)
c         write(*,*)'3. If you want TM-score normalized by the ',
c     $        'average length of two structures:'
c         write(*,*)'  >TMalign structure.pdb target.pdb -a'
         write(*,*)
