...
sub parse_input(){
    my $f=0;
    if(!getopts('b:c:d:l:r:s:h')){ &message(); }
...
sub message(){
    system("clear");
    print "Usage: mkpair.pl -b -c -d -l -r -s\n";
    print " Mandatory:\n";
    print " -d data_dir (where to find seq.txt and seq.dat)\n";
    print " Optional:\n";
    print " -b bin_dir (default=/net/dell/02/users/yzhang/public/mkinput/bin)\n";
    print " -c comm_dir (default=/net/dell/02/users/yzhang/public/mkinput/data)\n";
    print " -l libdir   (default=/library/yzhang/PDB)\n";
    print " -r rundir   (default=./tmp_mkpair)\n";
    print " -s benchmark|real (default=benchmard)\n";
    print "\n";
    exit(0);
}
