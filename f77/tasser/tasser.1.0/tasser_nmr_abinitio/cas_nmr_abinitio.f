c  pgf77 -Mextend -o cas_nmr_abinitio cas_nmr_abinitio.f
c  pgf77 -Mextend -O3 -Wl,-static -o cas_nmr_abinitio cas_nmr_abinitio.f
c  pgf77 -Mextend -O -s -fast -Wl,-static -o cas_nmr_abinitio cas_nmr_abinitio.f
...
c      call read_initial2        !read initial (x,y,z) from 'chain.dat'
