...
c     number of vectors on lattice
      ...
      real asr(ndim,-12:12)
      integer jbin(0:500)
      real bsr(ndim,16), acops(ndim,16)
      ...
      real atemp1,atemp2,exc,er1,er3,er4,er5,er6,er7,eh1c,acorder
      real h2,h3s,h3d,h4s,h4d,h5s,h5d,h6,hend
      real bh2,bh3s,bh3d,bh4s,bh4d,bh5s,bh5d,bh6,bhendn
      real codevsum,conew,didvsum,dinew,contt
      real en1,en2,en3
...
c     for ESHORTs (6)
      ...
      write(*,*) es2,es3,es4,es5,es6

      read(19,*) es3a,es3b,es3c
      write(*,*) es3a,es3b,es3c
...
c     initial model from templates
     ...
     +                             nfl2,ras2,Lch2)
      ...
      print *,"After template_initial2 STOP"
CM      STOP
...
CM         call template_simulation !simulate the templates
           call template_simulation(bNSa,BNSt,bNa,bNt,bNNa,bNNt,
     +                               N_sum,energ_sum,energ_sum2,
     +                               armsd_sum,N_rmsd,ncycle,N_rep,
     +                               aT_rep,aTs_rep,aTTs_rep,phot,nfl,
     +                               bh2,bh3s,nfl3,bh3d,bh4s,nfl4,
     +                               bh4d,bh5s,nfl5,bhf5,bh6,nfl6,
     +                               bhendn,ras,Lch,switch,i_fra,
     +                               n_fra,nfr,nfr_i,nfr_f,
     +                               icarep,ica,mv,xrep,yrep,zrep,x,y,
     +                               z,exrep,eyrep,ezrep,egxrep,
     +                               egyrep,egzrep,ecxrep,ecyrep,
     +                               eczrep,ebxrep,ebyrep,ebzrep,ex,
     +                               ey,ez,egx,egy,egz,ecx,ecy,ecz,
     +                               ebx,eby,ebz,en1,en2,en3,nop,noa,
     +                               nom,envir,acorder,contt,codevsum,
     +                               conew,didevsum,dinew,gx,gy,gz,AA,
     +                               itemp)
         stop
      endif
...
CM      call read_initial2        
     ...
     +                         ras4,nfl3,ras3,nfl2,ras2)
      ...
      print *,"After read_initial2 STOP"
      STOP
...
CM            call set_current
            call set_current(x,y,z,xrep,yrep,zrep,ica,vector,Lch)
CM            call initial_move   !update center, axis, energy            
CM            call initial_move(icnto,sumcto,Lch,nop,noa,nom,eprofo,seq,
CM     +                        envir,icnt,sumct,nopp,noaa,nomm,
CM     +                        codevsum,conew,didevsum,dinew,
CM     +             ehb1,ehb1a,ehb1b,ehb1c,ehb2,ehb3,
CM     +             ehb4,ehb5a,enb5b,mv,x,y,
CM     +             z,ica,gx,gy,gz,HBX,HBY,HBZ,CAX,CAY,CAZ,ex,ey,ez,egx,
CM     +             egy,egz,ebx,eby,ebz,ecx,ecy,ecz,acops,
CM     +             jbin,apar,alp,arlp,app,ala,arla,apa,
CM     +             alm,arlm,apm,sec,concut2,
CM     +                hh,ee,area,afs,mdis,n_dis,kdis,
CM     +                dist,dev,mdisl,kdisl,mcom,kcom,concut,
CM     +                McomCA,KcomCA,aweigCA,csr,asr,bsr,ibin,
CM     +                frga,frgb,vvv,exc,acut_cc,acut_bb,acut_vv,bcut_cc,
CM     +                bcut_bb,bcut_vv,dord,en2,en3,contt,
CM     +                ESHORT2,ESHORT3,ESHORT4,ESHORT4a,ESHORT5,ESHORT5a,
CM     +                ESHORT5b,ESHORT5c,ESHORT6,ESHORT7,ESHORT8,ESHORT9,
CM     +                ESHORT10,ESHORT11,diold,coold,dinew,cex,
CM     +                cey,cez,acrit,distL,aweig,dist_CA_cut,dis)
     ...
     +             jbin,apar,alp,arlp,app,ala,arla,apa,
...
ccc
            do 3333 iphot=1,phot !N_swap, iterate at fixed temperature
               ...
               do 4444 i_lch=1,Lch
                  ...
                  if(fff.le.bh2)then
CM                     call move2
                       call move2(nfl2,ras2,Np2,ica,v21,goodc,v22,
     +                      x,y,z,vx,vy,vz,
     +                 Lch,nop,nopp,nom,nomm,noa,noaa,afsn,afs,
     +                 seq,envir,dord,en1,eprofo,de,id,bNa,bNNa,itemp,
     +                 icnto,icnt,sumcto,sumct,codevsum,codev,
     +                 didevsum,didev,energ,bNt,bNNt) 
                  elseif(fff.le.bh3s)then
CM                     call move3s
                          call move3s(nfl3,ras3,Np2,ica,v21,goodc,v22,
     +                  x,y,z,vx,vy,vz,nop,nopp,nom,nomm,noa,noaa,
     +                  afsn,afs,seq,envir,eprofo,de,id,bNa,bNNa,
...
CM                     call move3d
     ...
     +                  afsn,afs,seq,envir,energ,id,bNa,bNNa,icnto,
...
CM                     call move4s
     ...
     +                  noaa,afsn,afs,eprofn,seq,envir,energ,id,bNa,
...
CM                     call move4d
     ...
     +                  afsn,afs,eprofn,seq,envir,id,bNa,bNNa,icnto,
...
CM                     call move5s
     ...
     +                  afs,eprofn,envir,id,bNa,bNNa,icnto,icnt,sumcto,
...
CM                     call move5d
     ...
     +                  seq,envir,id,bNa,bNNa,icnto,icnt,sumcto,sumct,
...
CM                     call move6
     ...
     +                 envir,eprofo,id,bNa,bNNa,icnto,icnt,sumcto,sumct,
...
CM                     call move_n_end
     ...
     +                      eprofn,envir,id,bNa,bNNa,icnto,icnt,sumcto,
     +                      sumct,eprofo,codevsum,codev,didevsum,didev,
     +                      bNt,bNNt,itemp)
                  else
CM                     call move_c_end
     ...
     +                      eprofn,seq,envir,id,bNa,bNNa,icnto,icnt,
     +                      sumcto,sumct,eprofo,codevsum,didev,
     +                      bNt,bNNt,itemp)
                  endif
 4444          continue
 3333       continue
...
CM            E_rep(itemp)=energy_tot() !whole energy
              E_rep(itemp)=energy_tot(icnto,sumcto,Lch,nop,noa,nom,
     +                                seq,envir,
     +                    acorder,contt,en1,en2,en3,icnt,
     +                    sumct,codevsum,conew,didevsum,dinew,
     +                    nopp,noaa,nomm) !whole energy
...
CM               write(30+k,'i8,1x,f10.1,2i8')Lch,E_rep(k),i_tr,icycle
               write(30+k,*)Lch,E_rep(k),i_tr,icycle
               do i=1,Lch
                  abx=xrep(i,k)*0.87
                  aby=yrep(i,k)*0.87
                  abz=zrep(i,k)*0.87
CM                  write(30+k,'f10.3,1x,f10.3,1x,f10.3')abx,aby,abz
                  write(30+k,*)abx,aby,abz
               enddo
            enddo
         endif
...
CM               icg(i)=0
               sequ(i)=name
CM               if(name.eq.'ASP'.or.name.eq.'GLU') icg(i)=-1
CM               if(name.eq.'LYS'.or.name.eq.'ARG') icg(i)= 1	
               go to 121
            endif
         enddo
         seq(i)=0
...
c     eonekd(A) controls centrosymmetric potential of C_g.
      subroutine read_centro(acrit,Lch)
      implicit integer(i-z)
      parameter(nvec=312)
      real eonekd(0:19),eonehw(0:19),acrit
...
ccccc     read centersymmetric potential finished
...
CM      common/seqe/seq(ndim),sec(ndim)
      ...
      integer jbin(0:500),sec(ndim),seq(ndim)
      real bsr(ndim,16), acops(ndim,16)
...
CM      common/rmsdder/i_chunk(ndim),ex0(ndim),ey0(ndim),ez0(ndim)
      ...
      print *,"Inside template_initial2"
...
cTTTTTTTTTTccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine template_simulation(bNSa,bNSt,bNa,bNt,bNNa,bNNt,
     +                               N_sum,energ_sum,energ_sum2,
     +                               armsd_sum,N_rmsd,ncycle,N_rep,
     +                               aT_rep,aTs_rep,aTTs_rep,phot,nfl,
     +                               bh2,bh3s,nfl3,bh3d,bh4s,nfl4,
     ...
     +                               itemp)
      ...
      dimension aTs_rep(nrep),aTTs_rep(nrep)
      dimension armsd_sum(nrep),N_rmsd(nrep)
      dimension icarep(ndim,nrep)
      dimension ica(0:ndim),x(ndim),y(ndim),z(ndim)
      dimension mv(ndim)
...
CM      COMMON/short2/ codevsum, didevsum, csr(ndim,2)
CM      common/backup1/NOPP(ndim),NOMM(ndim),NOAA(ndim),NHBNN(ndim)
CM      dimension x0(ndim),y0(ndim),z0(ndim)  !for E_min
CM      character*6 mname
CM      common/movename/mname(100)
CM      common/nrepfile/n_repf
...
CM      double precision bNa,bNt,bNNa,bNNt,bN5a,bN5t
CM
CM      dimension aNNa(100),aNNt(100),N_out(100) !for output annealing
CM
CM      common/frozen/L_cut,d_xyz0,d_xyz00(ndim),angle0,angle00(ndim)
CM
CM      common/sw1/aT_rep(nrep),E_rep(nrep)
...
CM
      ...
      do 1111 icycle=1,ncycle
         do 2222 itemp=1,N_rep  !iterate for all the replicas
            ...
            aTs=aTs_rep(itemp)
            aTTs=aTTs_rep(itemp)
CM            call set_current_RS !get current (x,y,z,ica,T)
              call set_current_RS(Lch,x,y,z,xrep,yrep,zrep,ica,icarep,
...
CM                           call trot_N !translate+rotate N-terminal
                             call trot_N(nfr_f,d_xyz00,angle00,ex,ey,ez,
     +                  x,y,z,anvec,ica,
...
CM                           call trot_C !translate+rotate C-terminal
                           call trot_C(nfr_i,d_xyz00,angle00,ex,ey,ez,
     +                  x,y,z,anvec,
...
CM                           call trot_M !translate+rotate Middle-fragment
                             call trot_M(nfr_i,d_xyz00,angle00,ex,ey,ez,
     +                  x,y,z,anvec,
     ...
     +                  didevsum,didev,bNt,bNNt,itemp)
                     ...
                     elseif(switch.eq.4)then !translation
                        if(nfr_i(ifr).eq.1)then
CM                           call tran_N !translate N-terminal
                             call tran_N(nfr_f,d_xyz00,ex,ey,ez,x,y,z,
     +                  anvec,goodc,vx,vy,
     ...
     +                  didev,bNt,bNNt,itemp)
                        elseif(nfr_f(ifr).eq.Lch)then
CM                           call tran_C !translate C-terminal
                        call tran_C(nfr_i,ifr,d_xyz00,ex,ey,ez,x,y,z,
     +                  anvec,ica,
...
CM                           call tran_M !translate Middle-fragment
                             call tran_M(nfr_i,nfr_f,ifr,d_xyz00,ex,ey,
     +                  ez,x,y,z,anvec,
...
CM                              call trot_N !translate+rotate N-terminal
     ...
     +                  didevsum,didev,bNt,bNNt,itemp)
                              ...
                              i_E_defo=1
CM                              call defo_N !translate+deform N-terminal
                                call defo_N(nfr_f,ifr,d_xyz00,angle00,
     +                  ex,ey,ez,x,y,z,anvec,
     +                  goodc,ica,vx,vy,vz,Nw,W21,W22,egx,egy,egz,ecx,
     +                  ecy,ecz,ebx,eby,ebz,Lch,nop,nopp,nom,nomm,noa,
...
CM                              call trot_C !translate+rotate C-terminal
     ...
     +                  codevsum,codev,didevsum,didev,bNt,bNNt,itemp)
                              ...
                              i_E_defo=1
C                              call defo_C !translate+deform C-terminal
                               call defo_C(nfr_i,ifr,d_xyz00,angle00,ex,
     +                  ey,ez,x,y,z,anvec,
...
CM                               call trot_M !translate+rotate Middle-fragment
     ...
     +                  didevsum,didev,bNt,bNNt,itemp)
                              ...
                              i_E_defo=1
CM                              call defo_M !translate+deform Middle-fragment
                                call defo_M(nfr_i,ifr,nfr_f,d_xyz00,
     +                  angle00,ex,ey,ez,x,y,z,
     +                  anvec,
...
CM      energy_tot_tmp=energy_tot()
        energy_tot_tmp=energy_tot(icnto,sumcto,Lch,nop,noa,nom,
     +                                seq,envir,
     +                    acorder,contt,en1,en2,en3,icnt,
     +                    sumct,codevsum,conew,didevsum,dinew,
     +                    nopp,noaa,nomm)
...
ccccccccccccccccccccccc<E>, NNa/NNt ccccccccccccccccccccccccccc
      ...
      do i=1,N_rep
        ...
        write(20,5006)i,aT_rep(i),energ_sum(i),
     &                armsd_sum(i)/(N_rmsd(i)+0.00001),
...
ccccc set current (x,y,z), ica, T, from itemp's replica
      subroutine set_current(x,y,z,xrep,yrep,zrep,ica,vector,Lch)
      implicit integer(i-z)
      parameter(ndim=1500)
      parameter(nrep=100)
      parameter(nvec=312)
...
c  old ---> new ---> old ----> new
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine move2(nfl2,ras2,Np2,ica,v21,goodc,v22,x,y,z,vx,
     +                 vy,vz,Lch,nop,nopp,nom,nomm,noa,noaa,afsn,
     +                 afs,seq,envir,dord,en1,eprofo,de,id,bNa,
     +                 bNNa,itemp,
     +                 icnto,icnt,sumcto,sumct,codevsum,codev,
     +                 didevsum,didev,energ,bNt,bNNt) 
      implicit integer(i-z)
...
CM         Enew=EHB(m,m2,1)+ESHORT(m,m2,1) !icnt,nop are repeated.
     ...
     +             z,ica,gx,gy,gz,HBX,HBY,HBZ,CAX,CAY,CAZ,ex,ey,ez,egx,
     +             egy,egz,ebx,eby,ebz,ecx,ecy,ecz,acops,
     +             jbin,Lch,apar,alp,nop,arlp,app,ala,noa,arla,apa,
     ...
     +                ESHORT5b,ESHORT5c,ESHORT6,ESHORT7,ESHORT8,ESHORT9,
     +                ESHORT10,ESHORT11,diold,coold,cex,
     +                cey,cez,acrit,distL,aweig,dist_CA_cut,dis) !icnt,nop are repeated
         do kkk=m,m2
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +                  afs,seq,envir,eprofo,de,id,bNa,bNNa,
...
CM         Enew=EHB(m,m3,1)+ESHORT(m,m3,1) !use ifs
     ...
     +                ESHORT5b,ESHORT5c,ESHORT6,ESHORT7,ESHORT8,ESHORT9,
     +                ESHORT10,ESHORT11,diold,coold,cex,
     +                cey,cez,acrit,distL,aweig,dist_CA_cut,dis) !use ifs
         do kkk=m,m3
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +                   seq,envir,energ,id,bNa,bNNa,icnto,icnt,sumct,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +                  afs,eprofn,seq,envir,energ,id,bNa,bNNa,icnto,
     +                  icnt,sumcto,sumct,eprofo,codevsum,codev,
     +                  didevsum,didev,bNt,bNNt,itemp)     
...
CM         Enew=EHB(1,m+1,1)+ESHORT(1,m+1,1) !use ifs
         ...
         Enew=ehb(m,m+1,1,ehb1,ehb1a,ehb1b,ehb1c,ehb2,ehb3,
     +             ehb4,ehb5a,enb5b,icnt,icnto,sumct,sumcto,seq,mv,x,y,
     +             z,ica,gx,gy,gz,HBX,HBY,HBZ,CAX,CAY,CAZ,ex,ey,ez,egx,
     +             egy,egz,ebx,eby,ebz,ecx,ecy,ecz,acops,
     +             jbin,Lch,apar,alp,nop,arlp,app,ala,noa,arla,apa,
     ...
     +             acut_cc,acut_bb,acut_vv,bcut_cc,bcut_bb,bcut_vv,
     +             dord,en2,en3,contt) +
     +             ESHORT(m,m+1,1,seq,mv,x,y,z,ica,gx,gy,gz,ex,ey,
     +                ez,egx,egy,egz,hh,ee,area,afs,mdis,n_dis,kdis,
     +                dist,dev,mdisl,kdisl,mcom,kcom,concut,
     +                McomCA,KcomCA,aweigCA,csr,asr,bsr,sec,ibin,hbx,
     +                hby,hbz,ebx,eby,ebz,cax,cay,caz,ecx,
...
CM         Eold=EHB(1,m+1,-1)+ESHORT(1,m+1,-1) !cut off old nop by istat=-1
         ...
         Eold=ehb(m,m+1,-1,ehb1,ehb1a,ehb1b,ehb1c,ehb2,ehb3,
     +             ehb4,ehb5a,enb5b,icnt,icnto,sumct,sumcto,seq,mv,x,y,
     +             z,ica,gx,gy,gz,HBX,HBY,HBZ,CAX,CAY,CAZ,ex,ey,ez,egx,
     +             egy,egz,ebx,eby,ebz,ecx,ecy,ecz,acops,
     +             jbin,Lch,apar,alp,nop,arlp,app,ala,noa,arla,apa,
     ...
     +                ESHORT5b,ESHORT5c,ESHORT6,ESHORT7,ESHORT8,ESHORT9,
     +                ESHORT10,ESHORT11,diold,coold,cex,
     +                cey,cez,acrit,distL,aweig,dist_CA_cut,dis) !cut off old nop by istat=-1
...
CM         Enew=ehb(1,n,1,ehb1,ehb1a,ehb1b,ehb1c,ehb2,ehb3,
CM     +             ehb4,ehb5a,enb5b,icnt,icnto,sumct,sumcto,seq,mv,x,y,
CM     +             z,ica,gx,gy,gz,HBX,HBY,HBZ,CAX,CAY,CAZ,ex,ey,ez,egx,
CM     +             egy,egz,ebx,eby,ebz,ecx,ecy,ecz,acops,
CM     +             jbin,Lch,apar,alp,nop,arlp,app,ala,noa,arla,apa,
CM     +             alm,nom,arlm,apm,sec) +eshort(1,n,1) !use ifs
         do kkk=1,n
            afsn(kkk)=afs(kkk)  !keep memory of ifs
         enddo
...
CM            call connect(i1,i2,pass)
           call connect(i1,i2,pass,cx,cy,cz,Lch,amcheck_dis) !fill missed cooridinates, no move others
      print*,'After Connect 1 pass',pass
...
CM            call connect(i1,i2,pass)
            call connect(i1,i2,pass,cx,cy,cz,Lch,amcheck_dis) !fill missed cooridinates, no move others
      print*,'After Connect 2 pass',pass
            if(pass.ge.3)goto 70 !re-walk
         endif
...
CM      energ=ehb(1,Lch,1)+eshort(1,Lch,10) !initialize all below parameters
     ...
     +                ESHORT5b,ESHORT5c,ESHORT6,ESHORT7,ESHORT8,ESHORT9,
     +                ESHORT10,ESHORT11,diold,coold,cex,
     +                cey,cez,acrit,distL,aweig,dist_CA_cut,dis) !initialize all below parameters
...
CM      common/seed1/no ! will overwrite whatever value we pass with global no
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +                cey,cez,acrit,distL,aweig,dist_CA_cut,dis)
      ...
      dimension cax(nvec,nvec),cay(nvec,nvec),caz(nvec,nvec)
      dimension IBIN(-300:300),asr(ndim,-12:12)
      dimension JBIN(0:500),bsr(ndim,16),acops(ndim,16)
      dimension afs(ndim)
      dimension frga(ndim),frgb(ndim)
      dimension csr(ndim,2)
      dimension gx(nvec,nvec,0:19),gy(nvec,nvec,0:19),gz(nvec,nvec,0:19)
