...
cccc  ouput header for energy terms
      write(30,'a')'#amt       energy        EHB1        EHB1a       '//
...
****************************************************
         do i=1,Lch
            q(i)=0
         enddo
         read(24,*)L_ali,amt !number of residues in the template and 1-TM score
         do i=1,L_ali
            read(24,*)ii,a1,a2,a3
            cx0(ii)=a1
            cy0(ii)=a2
