	...
	write(7,*)ncs
	do imv=324,ncs
	OPEN(unit=30,file='nametarg'//namefiles3(imv-99))
	OPEN(unit=20,file='LIST.targ'//pdb//namefiles3(imv-99))	
	write(30,210)pdb,namefiles3(imv-99)
210	format(a3,a3)
	id=1
	write(20,2)id,pdbf
2       format(i3,1x,a4)
	write(20,1)namep(imv)
1	format(a)
	end do
	close(20)
	stop
