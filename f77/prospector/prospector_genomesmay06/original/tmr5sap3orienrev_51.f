	OPEN(UNIT=9,FILE='stat_tmr5sap3orienrev_5.1')
	CALL r14STAT()
	STOP
	END
	...
	CHARACTER*21 TEXT
	CHARACTER*5 name5,namep2(ncases)
	character*4 genome
	CHARACTER*6 prodin
...
1033    FORMAT(a20,2X,I4,1x,3X,3F8.3,1x,i4,1x,a3)
	...
	write(10,40)mres,Rcomm, TMS,zth
40	format(i4,1x,3(1f7.3,1x))
