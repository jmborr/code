...
c	=================================
	...
	OPEN(unit=20,file=home//'strlist/BLOSUM_INT')
	read(20,*)
	do i=0,19
	...
	READ(20,1)NAME(ik)
1	format(a5)
	OPEN(unit=30,file='/nfs/users/skolnick/orien6/'//NAME(ik)//'.SEQ')
	rewind(30)
...
2	format(a5,1x,i5)
	...
	rewind(30)
	close(30)
	OPEN(unit=71,file='/nfs/users/skolnick/orien6fit/'//NAME(ik)//
     &	'.FITCONT_OR')
	rewind(71)
	do i=1,nres(ik)
...
c	======================================================
	...
	OPEN(UNIT=27,file=home//'strlist/SCALEAV2',status='old')
	read(27,*)
	read(27,*)
	DO I=0,19
...
c       OPEN(unit=44,file='/nfs/users/skolnick//'//genome//'PAIROR/'//namep(1:nsize)//
c    &  '.PAIRHOMGSORORIEN3590')
c       do ils=1,3
c      do i=1,nresseq
c      read(44,*)
c      read(44,167) (an01(i,j,ils),j=1,nresseq)
c      read(44,*)
c      end do
c       end do
c       close(44)
...
c        an01(i,j,ils)=(an02(i,j,ils)+0.25*an01(i,j,ils))/1.25
	...
	homology(jk)=.true.
        ...
        open(unit=8,file='/nfs/users/skolnick/pdbhomoljan05/'//namep(1:nsize)//'.homol')
	read(8,*)nhom
	do id=1,nhom
...
6543	continue
	...
	OPEN(unit=21,file=home//genome//'zpot4a/'//namep(1:nsize)//'.predictedrap3orienrev')
	write(21,*)nt/2
	do i=1,mres
	ires=jcode(i)
	do j=1,mres	
...
c871 	format(a1,3x,a1,2x,i4,2x,i4)
	...
	write(9,*)'============================='
	OPEN(unit=44,file=home//genome//'zpot4a/'//namep(1:nsize)//'.potcontactexpr1ap3orienrev') 
	do ils=1,3
        do i=1,mres
        iseq=jcode(i)
        write(44,*)i,aa(iseq)
 ...
 167     FORMAT(25F5.1)
        ...
        OPEN(unit=37,file=home//'/'//genome//'pdborienrev4/'//namep(1:nsize)//'rap3orienrevall1.pdb')
 	do k=1,4
	if(k.lt.3)then
	kup=20
	else
	...
	OPEN(unit=45,file='/nfs/users/skolnick/cafiles6/'//NAME(iik)//'.real')
	rewind(45)
	read(45,*)nres(iik)
