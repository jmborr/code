...
c871 	format(a1,3x,a1,2x,i4,2x,i4)
	...
	write(9,*)'============================='
	OPEN(unit=44,file=home(1:nhome)//genome//'zpot4a/'//namep(1:nsize)//'.potcontactexprsap3orienrev') 
	do ils=1,3
        do i=1,mres
        iseq=jcode(i)
        write(44,*)i,aa(iseq)
...
665	format(a5,1x,i4,1x,1f7.3,1x,i3)
	...
	write(37,906)'TER',pid/ni
	 ...
	 OPEN(unit=34,file=home(1:nhome)//genome//'pdborienrev/'//namep(1:nsize)//'rap3orienrevs.pdb')
