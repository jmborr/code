...
C Compiler    : Absoft Pro Fortran 77
C To compile  : f77 -c -N109 f2kcli.for
...
C
      ...
      INTEGER       STATUS
C
      INTEGER       IPOS,ISTART,IEND,NARGS,IPOS1,LENARG,ISTAT,IENV
      CHARACTER*127 ARGSTR
...
C
      IF (NUMBER.EQ.0) THEN
C
C IENV = Address of environment in the Phar Lap DOS extender (2C0000h)
C
          IENV  = 2883584
C
