...
C
C Platform    : DOS/DBOS and Windows 3.1/9x/Me+WDBOS
C Compiler    : Salford FTN77/DBOS
C To compile  : ftn77 f2kcli
...
C
      ...
      ENDIF
C
C Use a run time library routine to get executable name
C
      IF (NUMBER.EQ.0) THEN
