...
!               df /c f2kcli.f90         (Digital/Compaq Visual Fortran)
!               ftn90 f2kcli.f90         (Salford FTN90)
!               ftn95 f2kcli.f90         (Salford FTN95)
!               fl32 /c f2kcli.f90       (Microsoft PowerStation)
!               f90 -c -t 2 f2kcli.f90   (Absoft)
!               ifl -c f2kcli.f90        (Intel Fortran up to 7.x)
!               ifort -c f2kcli.f90      (Intel Fortran 8.x)
