...
typedef struct {
  ...
  double edm;
  double edmo;
  int lt; /*list type for this collision*/
  double dmsf2;
  double dpsf2;
  well_type next;
...
typedef struct {
  ...
  double d1;
  double d2;
  crd sfr;   /*position of last safe-limit update*/
} atom;
/*
...
extern atom_number twall(atom_number i,double * t);
extern atom_number tsf(atom_number i,double *t);
enum list_type tball(atom_number i1, atom_number j1, coll_type ct, double * t);
enum list_type tball_sf(atom_number i1, atom_number j1, coll_type ct,
			double * t);
extern coll_type collision_type(atom_number i,atom_number k);
extern void collision_sf(atom_number p);
