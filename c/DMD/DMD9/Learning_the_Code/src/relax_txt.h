...
const static hp_t dmd_atom_hp[]={
  ...
  AMPHI, AMPHI, AMPHI, AMPHI, IRRELEVANT,
  POLAR, POLAR, AMPHI, POLAR, AMPHI,
  POLAR, AMPHI, AMPHI, AMPHI, POLAR,
  /*CG1*/
  AMPHI, AMPHI, APOLOR, APOLOR, APOLOR,
  APOLOR, AMPHI, AMPHI, IRRELEVANT, IRRELEVANT,
  AMPHI, POLAR, POLAR, POLAR, POLAR, 
  POLAR, POLAR, POLAR, POLAR, AMPHI,
  /*CG2*/
  APOLOR, POLAR, APOLOR
};
