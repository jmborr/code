...
int main(int argc, char **argv){
  ...
  double minTM=0.40; /*default minimum TM score*/
  double maxTM=0.90; /*default maximum TM score*/
  int nbin=5;        /*default number of TM score bins*/
  ...
  for(bin=0; bin<nbin; bin++){
    ...
    if(!nubin) continue; /*no snapshots in this TM score bin. Thus, go to next bin*/
