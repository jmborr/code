...
ih=inpHand('Usage: rankSeqsBySSsimilarity.py',
           ...
           ' -b _RA_hongf hongpred.dat file containing predicted secondary assignments for the sequence ',
           ' -c __header header'
...
ss=open(hongf,'r').readline().strip() ; ss=ss.replace('L','C') ; ss=ss.replace('B','E')
weights=[1.0]*len(ss)
