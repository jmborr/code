...
pf=open(outf,'w')
pf.write('#Header Biggest(densRank,numberdens,dens,rmsd,TM) Densest(sizeRank,numberdens,dens,rmsd,TM)  BestRmsd(densRank,SizeRank,numberdens,dens,rmsd) BestTM(densRank,sizeRank,numberdens,dens,TM)\n')
...
for header in list:
    ...
    c4=p.numberdens[bestRmsdId]
    c5=p.dens[bestRmsdId]
    ...
    #output line
    pf.write('%7s %2d %4.2f %7.5lf %5.2f %4.2f  %2d %4.2f %7.5lf %5.2f %4.2f  %2d %2d %4.2f %7.5lf %5.2f  %2d %2d %4.2f %7.5lf %4.2f\n'%(header,a0,a4,a5,a1,a3,  b0,b4,b5,b1,b3,  c0,c1,c4,c5,c2,  e0,e1,e4,e5,e2 ))
