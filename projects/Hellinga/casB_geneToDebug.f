...
*****************************************************************************
*     To compile, use:
*     pgf77 -Mextend -O -s -fast -Wl,-static -o casB_geneToDebug casB_geneToDebug.f *
...
c 3456789012345678901234567890123456789012345678901234567890123456789012345678
      ...
      common/vectors/vx(nvec),vy(nvec),v(nvec),vector(-5:5,-5:5,-5:5)
...
********************************************************
      ...
      do i=1,M_a
         L_a=M_f(i)-M_i(i)+1
         if(L_a.le.L_cut)then !remove if aligned segments less than L_cut=5 residues
            do j=M_i(i),M_f(i)
               q(j)=0
            enddo
         endif
...
ccc   
            do 3333 iphot=1,phot !N_swap, iterate at fixed temperature
               do 4444 i_nfl=1,nfl
                  fff=aranzy()
                  write(*,'ai3ai3af5.3')'iphot=',iphot,' icycle=',
     &                 icycle,' fff=',fff
                  write(*,109)'bh2=',bh2,'bh3s=',bh3s,'bh3d=',bh3d,
     &                 'bh4s=',bh4s,'bh4d=',bh4d,'bh5s=',bh5s,'bh5d=',
     &                 bh5d
                  if(fff.le.bh2)then
                     call move2
                  elseif(fff.le.bh3s)then
...
c     choose the position of (m) ----------->
      ...
      m1=m+1
      m2=m+2
      write(*,'5(xai4)')'nfl2=',nfl2,'i=',i,'m=',m,'m1=',m1,'m2=',m2
