c	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
c
c       pgf77 -Mextend -O -s -fast -Wl,-static -o contactsev3_3.x contactsev3_3.f
c
...
C     &		     'H','F','Y','W','X'/
	...
	OPEN(UNIT=20,FILE='LIST.structures_fo')
...
c	open(unit=10,file='/gpfs1/scratch/jose/Hellinga/filtered/'//name(1:nsize))
	open(unit=10,file='/gpfs1/scratch/jose/foldsOrigin/600x10/'//name(1:nsize))
